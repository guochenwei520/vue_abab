  ...
  <el-table :data="opusData" style="width: 100%" class="game-table">
    ...
    <el-table-column fixed="right" label="操作" min-width="120">
      <template #default="code">
        <el-button link type="primary" size="small" @click="delOpus(code.row.opusId)"
...
function delOpus(opusId) {
  likeDel.value.opusId = opusId
  getUserLikeDel(likeDel.value).then(res =>{
